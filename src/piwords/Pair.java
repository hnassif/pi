...
public class Pair<X extends Comparable<X>, Y extends Comparable<Y>>
    ...
    public int compareTo(Pair<X ,Y> otherPair) {
    	...
    	int result= this .first.compareTo(otherPair.first);// compare first using the compareTo method
    	if (result==0) {
    		result= this.second.compareTo(otherPair.second);// compare second using compareTo method
